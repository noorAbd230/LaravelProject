@extends('layouts.app')
 @section('page-name')
       <a class="h4 mb-0 text-white text-uppercase" href="{{ url('category/create') }}">create category</a>
       @stop  
@section('content')
  ...
  <body style="background-color: #a598ee;">
        ...
        <div class="container" >
        <div class="col-md-12">         
            <form class="form-horizontal templatemo-login-form-2" enctype="multipart/form-data" role="form" action="{{ url('category/store') }}" method="post">
                        ...
                        <div class="form-group">
                          <div >
                            ...
                            <div class="templatemo-input-icon-container">
                                ...
                                <input type="file" class="form-control"  name="cImg" id="cImg" placeholder="">
