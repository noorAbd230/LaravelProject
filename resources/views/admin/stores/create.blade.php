...
@section('page-name')
       <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ url('stores/create') }}">create stores</a>
       @stop
@section('content')
  ...
  <body style="background-color: #a598ee;">
        ...
        <div class="container" >
        <div class="col-md-12">         
            <form class="form-horizontal templatemo-login-form-2" enctype="multipart/form-data" role="form" action="{{ url('stores/store') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="row" >
                    <div style=" margin-top: 110px;">
                        <h1 style="color: white;">New Store</h1>
                    </div>
                </div>
        ...
        <img src="/images/bg-2.png" height="300" style="position: absolute; right: 80px; top: 210px;" >
